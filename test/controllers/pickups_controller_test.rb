...
class PickupsControllerTest < ActionController::TestCase
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post :create, pickup: { driver_id: @pickup.driver_id, prod_size: @pickup.prod_size, shopper_id: @pickup.shopper_id, user_num: @pickup.user_num }
    end
  ...
  test "should update pickup" do
    patch :update, id: @pickup, pickup: { driver_id: @pickup.driver_id, prod_size: @pickup.prod_size, shopper_id: @pickup.shopper_id, user_num: @pickup.user_num }
    assert_redirected_to pickup_path(assigns(:pickup))
  end
