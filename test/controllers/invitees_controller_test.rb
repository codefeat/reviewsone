...
class InviteesControllerTest < ActionController::TestCase
  ...
  test "should create invitee" do
    assert_difference('Invitee.count') do
      post :create, invitee: { email: @invitee.email, fname: @invitee.fname, lname: @invitee.lname, sent_by_id: @invitee.sent_by_id }
    end
  ...
  test "should update invitee" do
    patch :update, id: @invitee, invitee: { email: @invitee.email, fname: @invitee.fname, lname: @invitee.lname, sent_by_id: @invitee.sent_by_id }
    assert_redirected_to invitee_path(assigns(:invitee))
  end
