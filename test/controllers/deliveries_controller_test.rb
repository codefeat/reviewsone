...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('delivery.count') do
      post :create, delivery: { address: @delivery.address, name: @delivery.name, phone: @delivery.phone, website: @delivery.website }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { address: @delivery.address, name: @delivery.name, phone: @delivery.phone, website: @delivery.website }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
